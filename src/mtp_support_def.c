...
//	MTP_OPERATION_END_EDIT_OBJECT                        ,//0x95C5
	...
	MTP_OPERATION_NIKON_GET_EVENT,
	MTP_OPERATION_NIKON_DEVICE_READY,
	MTP_OPERATION_NIKON_INITIATE_CAPTURE_REC_IN_SDRAM,
	MTP_OPERATION_NIKON_AF_AND_CAPTURE_REC_IN_SDRAM,
...
const unsigned short supported_event[]=
{
	...
	MTP_EVENT_NIKON_OBSOLETE_EVENT,
	MTP_EVENT_NIKON_OBJECT_ADDED_IN_SDRAM,
	MTP_EVENT_NIKON_CAPTURE_COMPLETE_REC_IN_SDRAM,
};
